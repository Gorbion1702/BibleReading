...
app.get('/api/cron/reminder', async (req, res) => {
    try {
        ...
        for (const user of users) {
            ...
            if (!hasShared && phone) {
                const waMessage = `Syalom ${name} 👋,\n\nSudahkah kamu bible reading hari ini? Yuk, luangkan waktu sejenak bersama Tuhan dan bagikan berkatmu di Bible Reading Perkantas Jabar agar streak-mu tidak putus!\n\nKlik link ini: https://bible-reading-perkantas.vercel.app/ \n\nSelamat merenungkan firman-Nya! 🙏`;
